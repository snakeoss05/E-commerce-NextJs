...
export default function Banner() {
  return (
    <div className="flex flex-col lg:flex-row items-center justify-center py-8 gap-8 px-4 lg:px-24">
      <div className="flex justify-center items-center flex-col gap-4">
        <svg
          ...
          viewBox="0 0 41 40"
          fill="none"
          className="bg-black rounded-full p-2 border-8 border-gray-200 h-16 w-16"
          xmlns="http://www.w3.org/2000/svg">
          <g clipPath="url(#clip0_824_335)">
            <path
        ...
        <p className="text-base text-black">
          Free delivery for all orders over 300DT
        </p>
      </div>
      <div className="flex justify-center items-center flex-col gap-4">
        <svg
        ...
        <p className="text-base text-black">Friendly 24/7 customer support</p>
      </div>
      <div className="flex justify-center items-center flex-col gap-4">
        <svg
          width="40"
        ...
        <p className="text-lg font-bold text-black">Money Back Guarantee</p>
        <p className="text-base text-black">30 days money back guarantee</p>
      </div>
    </div>
  );
}
