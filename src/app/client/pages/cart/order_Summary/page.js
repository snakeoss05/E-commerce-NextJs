    ...
    <div className="flex flex-col items-center justify-center ">
      ...
      <div className="bg-white py-8 antialiased dark:bg-gray-900 md:py-16 ">
        <form action="#" className="mx-auto max-w-screen-xl px-4 2xl:px-0">
          <div className="mx-auto max-w-3xl grid gap-8 lg:max-w-none lg:grid-cols-2">
            <div className="mt-6 space-y-4 py-8 dark:border-gray-700 sm:mt-8">
            ...
            <div className="mt-2 sm:mt-8">
              <div className="mt-2 sm:mt-8 space-y-6">
